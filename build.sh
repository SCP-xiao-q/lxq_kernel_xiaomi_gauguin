...
export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/clang-r383902/bin:/home/xiaoq/Kernel/Toolchain/google_gcc/aarch64-linux-android-4.9/bin:/home/xiaoq/Toolchain/google_gcc/arm-linux-androideabi-4.9/bin:$PATH"
export SUBARCH=arm64

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-20/bin:$PATH"

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-11/bin:$PATH"

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-12/bin:$PATH"

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-13/bin:$PATH"

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-16/bin:$PATH"

#export PATH="/home/xiaoq/bin:/home/xiaoq/Kernel/ZyC-clang-10/bin:$PATH"

LOCAL_VERSION_NUMBER=LXQ-v0.1
...
THREAD=$(nproc --all);
CC_ADDITION_FLAGS="OBJDUMP=llvm-objdump 2>&1 | tee build.log";
OUT="../out";
...
make_defconfig(){
    ...
    make CC=$CC ARCH=$ARCH CLANG_TRIPLE=$CLANG_TRIPLE CROSS_COMPILE=$CROSS_COMPILE CROSS_COMPILE_COMPAT=$CROSS_COMPILE_COMPAT O=$OUT -j$THREAD $DEFCONFIG_NAME;
}
...
build_kernel(){
    ...
    make CC=$CC ARCH=$ARCH SUBARCH=$SUBARCH CROSS_COMPILE=$CROSS_COMPILE CROSS_COMPILE_COMPAT=$CROSS_COMPILE_COMPAT CLANG_TRIPLE=$CLANG_TRIPLE $CC_ADDITION_FLAGS O=$OUT -j$THREAD;
    END_SEC=$(date +%s);
